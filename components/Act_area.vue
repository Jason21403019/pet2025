      ...
      <div class="act-area__content">
        ...
        <div class="act-area__rules">
          ...
          <div class="act-area__section">
            ...
            <p>
              Step 1 登入 udn 會員 → Step 2 填寫問卷 → Step 3 會員中心填 e-mail
              和手機 → Step 4 期待開獎
            </p>
          </div>
          <div class="act-area__section">
          ...
          <div class="act-area__section">
            ...
            <ul class="act-area__info-list">
              ...
              <li class="act-area__info-list-items act-area__sub-item">
                2. 冷凍冷藏商品不適用，常溫商品滿500元可折抵100元。
              </li>
              <li class="act-area__info-list-items act-area__sub-item">
                3. 需於有效期限內使用完畢，逾期未使用即失效視同放棄。
              </li>
              <li class="act-area__info-list-items act-area__sub-item">
                4.
                使用優惠碼折抵的訂單，同樣可以申請退貨，但折扣金額不會歸還，優惠碼也不會進行補發，請務必要謹慎使用。
              </li>
              <li class="act-area__info-list-items act-area__sub-item">
